 ...
 */
function hook_spid_pasw_user_roles_alter(&$roles, $attributes) {
 ...
 */
function hook_spid_pasw_allow_login($attributes) {
 ...
 */
function hook_spid_pasw_existing_user($attributes) {
 ...
 */
function hook_spid_pasw_user_attributes(\Drupal\user\UserInterface $account, $attributes) {
